/** Prompt the user for five integers and compute the sum, product, minimum and maximum. */
import java.util.Scanner;

public class TestSumProductMinMax5 {
    ...
    private static void compute5Numbers() {
        ...
        System.out.printf(
                "The sum of %d, %d, %d, %d and %d is %d%n"
                        + "The product of %d, %d, %d, %d and %d is %d%n"
                        + "The max of %d, %d, %d, %d and %d is %d%n"
                        + "The min of %d, %d, %d, %d and %d is %d%n",
                number1, number2, number3, number4, number5, sum, number1, number2, number3,
                number4, number5, product, number1, number2, number3, number4, number5, max,
