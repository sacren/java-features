/**
 * On the phone keypad, the alphabet is mapped to digits as follows: ABC(2), DEF(3), GHI(4), JKL(5),
 * MNO(6), PQRS(7), TUV(8), WXYZ(9). # In simulation, prompt the user for a string (case
 * insensitive) and convert it to a sequence of keypad digits.
 */
import java.util.Scanner;

public class TestPhoneKeyPad {
