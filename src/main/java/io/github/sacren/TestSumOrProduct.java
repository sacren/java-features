...
public class TestSumOrProduct {
    ...
    public static void sumDivisible() {
        ...
        System.out.printf(
                "Between 1 and 1000, the sum of integers divisible by 13, 15, or 17 "
                        + "but not by 30 is %d%n",
                sum);
    }
    ...
    public static void sumOddNumbers() {
        ...
        System.out.printf(
                "Between %d and %d, the sum of all odd numbers is %d%n",
    ...
    private static void productOfIntegers() {
        ...
        System.out.printf(
                "Between %d and %d, the product of integer series is %d%n",
    ...
    public static void sumOfSquares() {
        ...
        System.out.printf(
                "Between %d and %d, the sum of all the squares is %d%n",
                lowerBound, upperBound, sum);
    }
}
